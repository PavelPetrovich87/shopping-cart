  ...
  forbidden: [
    {
      ...
      to: { path: '^(src/application|src/adapters|src/ui)' }
    },
    {
      name: 'application-orchestrates-only',
      severity: 'error',
      from: { path: '^src/application' },
      to: { path: '^(src/adapters|src/ui)' }
    },
    {
      name: 'ui-agnostic-infrastructure',
      severity: 'warn',
      from: { path: '^src/ui' },
...
// generated: dependency-cruiser@17.3.8 on 2026-03-10T14:38:42.467Z
