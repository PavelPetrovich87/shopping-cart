...
- **Subtasks**:
  - [ ] T001: Create base `Money` class structure
  - [ ] T002: Implement static factory methods (`fromCents`, `fromPrice`)
  - [ ] T003: Implement arithmetic operations (`add`, `subtract`, `multiply`)
  - [ ] T004: Implement comparison (`equals`)
  - [ ] T005: Implement USD formatting (`format`)
