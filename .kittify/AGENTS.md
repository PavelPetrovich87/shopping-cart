...
**[WARNING]️ CRITICAL**: All AI agents working in this project must follow these rules.
...
[NO] **Windows-1252 smart quotes**: " " ' ' (from Word/Outlook/Office)
[NO] **Em/en dashes and special punctuation**: --- --
[NO] **Copy-pasted arrows**: -> (becomes illegal bytes)
[NO] **Multiplication sign**: x (0xD7 in Windows-1252)
[NO] **Plus-minus sign**: +/- (0xB1 in Windows-1252)
[NO] **Degree symbol**:  degrees (0xB0 in Windows-1252)
[NO] **Copy/paste from Microsoft Office** without cleaning
