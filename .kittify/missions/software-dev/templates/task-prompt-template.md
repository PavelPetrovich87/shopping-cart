...
- [NO] Adding new entry at the top (breaks chronological order)
- [NO] Using future timestamps (causes acceptance validation to fail)
- [NO] Lane mismatch: frontmatter says `lane: "done"` but log entry says `lane=doing`
- [NO] Inserting in middle instead of appending to end
