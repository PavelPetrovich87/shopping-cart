...
## рџ"Ќ WORKING DIRECTORY: Run from MAIN repository
...
- When outstanding issues exist, do **not** attempt to force acceptanceвЂ"return the checklist and prompt the user to fix the blockers.